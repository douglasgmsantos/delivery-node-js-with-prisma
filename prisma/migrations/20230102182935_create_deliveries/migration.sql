...
-- AddForeignKey
ALTER TABLE "deliveries" ADD CONSTRAINT "deliveries_id_develiryman_fkey" FOREIGN KEY ("id_develiryman") REFERENCES "deliveryman"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
